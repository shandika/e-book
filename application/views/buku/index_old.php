        ...
        <div class="accordion custom-accordion" id="custom-accordion-one">
            ...
            <div class="card mb-1">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="card-body">
                        <div class="overflow-auto" id="teks" style="height: 500px;">
                            <h5 class="text-primary fw-bold text-center">Tes Pemahaman Konsep</h5>
                                <div class="d-flex bd-highlight">
                                    ...
                                    <div class="p-2 bd-highlight">
                                        <button id="btn-mulai" class="btn btn-info btn-rounded" onclick="intCount()"><i class="fa fa-play"></i> Mulai</button>
                                    </div>
                                </div>
                                <div>
                                    <ul>
                            ...
                            <h5 class="text-primary fw-bold text-center">Tes Keterampilan Berpikir Reflektif</h5>
                                ...
                                <div>
                                    <p>1. Setelah saya memahami bagaimana besarnya ketergantungan makhluk hidup terhadap air, maka kadar keyakinan saya bahwa keberadaan air di muka bumi yang melimpah merupakan bentuk kasih sayang yang dianugerahkan oleh Tuhan YME:</p>
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-1"
                                                        value="u-1" id="u-1">
                                ...
                                <div>
                                    <p>2. Setelah mempelajari bagaimana pentingnya siklus air sebagai mekanisme penyediaan dan penyebaran air tawar bagi seluruh makhluk hidup yang ada di muka bumi, maka kadar keyakinan saya bahwa adanya siklus air merupakan bentuk kasih sayang yang dianugerahkan oleh Tuhan YME:</p>
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-2"
                                                        value="u-5" id="u-4">
                                                    <label class="form-check-label" for="u-5">
                                                    Meningkat
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-2"
                                                        value="u-6" id="u-6">
                                                    <label class="form-check-label" for="u-6">
                                                    Menurun
                                                    </label>
                                                </div>
                                            </form>
                                ...
                                <div>
                                    <p>3. Setelah saya mempelajari bagaimana rumitnya proses reaksi kimia yang dibutuhkan untuk dapat menghasilkan air, maka kadar keyakinan saya bahwa keberadaan air di muka bumi bukan merupakan kebetulan semata melainkan ciptaan Tuhan YME:</p>
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-3"
                                                        value="u-7" id="u-7">
                                                    <label class="form-check-label" for="u-7">
                                                    Meningkat
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-3"
                                                        value="u-8" id="u-8">
                                                    <label class="form-check-label" for="u-8">
                                                    Tetap
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-3"
                                                        value="u-9" id="u-9">
                                                    <label class="form-check-label" for="u-9">
                                                    Menurun
                                                    </label>
                                                </div>
                                            </form>
                                ...
                                <div>
                                    <p>4. Setelah saya mempelajari tentang rumitnya karakteristik struktur molekul air, kadar keyakinan saya bahwa setinggi apapun ilmu dan teknologi yang dikuasai manusia untuk dapat menghasilkan air, tidak akan pernah dapat menyamai ilmu Tuhan YME dalam menetapkan proses alamiah penciptaan air</p>
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-4"
                                                        value="u-10" id="u-10">
                                                    <label class="form-check-label" for="u-10">
                                                    Meningkat
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-4"
                                                        value="u-11" id="u-11">
                                                    <label class="form-check-label" for="u-11">
                                                    Tetap
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-4"
                                                        value="u-12" id="u-12">
                                                    <label class="form-check-label" for="u-12">
                                                    Menurun
                                                    </label>
                                                </div>
                                            </form>
                                ...
                                <div>
                                    <p>5. Setelah saya mempelajari tentang perubahan wujud air dalam bentuk padat, cair dan gas yang terjadi di permukaan bumi, kadar keyakinan saya bahwa dapat menetapnya air dalam bentuk 3 wujud (padat, cair dan gas) dipermukaan bumi dengan kadar yang tepat merupakan bentuk kesimbangan yang telah Tuhan YME tetapkan untuk dapat menunjang kehidupan di bumi.</p>
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-5"
                                                        value="u-13" id="u-13">
                                                    <label class="form-check-label" for="u-13">
                                                    Meningkat
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-5"
                                                        value="u-14" id="u-14">
                                                    <label class="form-check-label" for="u-14">
                                                    Tetap
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-5"
                                                        value="u-15" id="u-15">
                                                    <label class="form-check-label" for="u-15">
                                                    Menurun
                                                    </label>
                                                </div>
                                            </form>
                                ...
                                <div>
                                    <p>6. Setelah saya mempelajari tentang persebaran air tawar di muka bumi sebagai hasil dari siklus hair, , kadar keyakinan saya bahwa adanya siklus air merupakan mekanisme yang telah Allah SWT untuk tetap menjaga keseimbangan kadar air tawar di muka bumi untuk dapat menunjang kehidupan di bumi.</p>
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-6"
                                                        value="u-16" id="u-16">
                                                    <label class="form-check-label" for="u-16">
                                                    Meningkat
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-6"
                                                        value="u-17" id="u-17">
                                                    <label class="form-check-label" for="u-17">
                                                    Tetap
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-6"
                                                        value="u-18" id="u-18">
                                                    <label class="form-check-label" for="u-18">
                                                    Menurun
                                                    </label>
                                                </div>
                                            </form>
                                ...
                                <div>
                                    <p>7. Setetlah saya mempelajari tentang kelebihan karakteristik yang dimiliki air sebagai akibat dari struktur molekul ikatan kovalen air berbentuk V dan ikatan struktur ikatan hidrogen antar molekul air, kadar keyakinan saya bahwa struktur molekul  air yang terbentuk  itu bukan semata fenomena alam melainkan telah didesain dan di bentuk dengan tujuan yang jelas oleh Tuhan YME:</p>
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-7"
                                                        value="u-19" id="u-19">
                                                    <label class="form-check-label" for="u-19">
                                                    Meningkat
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-7"
                                                        value="u-20" id="u-20">
                                                    <label class="form-check-label" for="u-20">
                                                    Tetap
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-7"
                                                        value="u-21" id="u-21">
                                                    <label class="form-check-label" for="u-21">
                                                    Menurun
                                                    </label>
                                                </div>
                                            </form>
                                ...
                                <div>
                                    <p>8. Setelah saya mempelajari tentang struktur molekul air dalam wujud padat, cair dan gas yang masing-masing menghasilkan karakteristk yang berbebeda, kadar keyakinan saya bahwa struktur molekul  air yang berbeda pada wujud padat, cair dan gas bukan semata fenomena alam melainkan telah didesain dan di bentuk dengan tujuan yang jelas oleh Tuhan YME:</p>
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-8"
                                                        value="u-22" id="u-22">
                                                    <label class="form-check-label" for="u-22">
                                                    Meningkat
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-8"
                                                        value="u-23" id="u-23">
                                                    <label class="form-check-label" for="u-23">
                                                    Tetap
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-8"
                                                        value="u-24" id="u-24">
                                                    <label class="form-check-label" for="u-24">
                                                    Menurun
                                                    </label>
                                                </div>
                                            </form>
                                ...
                                <div>0
                                    <p>9. Setelah saya mempelajari tentang berbagai keteratuan dan kepresisian dalam proses terbentuknya molekul air, proses perubahan wujud yang terjadi serta siklus air yang terjadai di muka bumi,  kadar keyakinan saya bahwa Tuhan YME Maha menguasai segala ilmu pengetahuan meliputi yang ada di alam semesta</p>
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-9"
                                                        value="u-25" id="u-25">
                                                    <label class="form-check-label" for="u-25">
                                                    Meningkat
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-9"
                                                        value="u-26" id="u-26">
                                                    <label class="form-check-label" for="u-26">
                                                    Tetap
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-9"
                                                        value="u-27" id="u-27">
                                                    <label class="form-check-label" for="u-27">
                                                    Menurun
                                                    </label>
                                                </div>
                                            </form>
                                ...
                                <div>
                                    <p>10. Setelah saya mempelajari bagaimana proses turunynya huan di suatu tempat sangat bergantung pada pergerakan arah angin yang ikut menggerakan awan, kadar keyakinana saya bahwa meskipun manusia memiliki pengetahuan tentang ramalan/prediksi terjadinya hujan di suatu tempat, ketidakpastian prediksi tersebut menunjukan bahwa ilmu pengetahuan yang dimiliki manusia itu hanya bagian kecil saja dari seluruh Ilmu pengathuan yang dimiliki Tuhan YME:</p>
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-10"
                                                        value="u-289" id="u-289">
                                                    <label class="form-check-label" for="u-289">
                                                    Meningkat
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-10"
                                                        value="u-29" id="u-29">
                                                    <label class="form-check-label" for="u-29">
                                                    Tetap
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-10"
                                                        value="u-30" id="u-30">
                                                    <label class="form-check-label" for="u-30">
                                                    Menurun
                                                    </label>
                                                </div>
                                            </form>
                                ...
                                <div>
                                    <p>11. Setelah saya mempelajari bagaimana terbentuknya embun pagi hari dan manfaatnya bagai makhluk hidup, kadar keyakinan saya bahwa adanya embun merupakan mekanisme yang telah Tuhan YME tetapkan untuk menjaga kelembaban tumbuhan dan tanah</p>
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-11"
                                                        value="u-31" id="u-31">
                                                    <label class="form-check-label" for="u-31">
                                                    Meningkat
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-11"
                                                        value="u-32" id="u-32">
                                                    <label class="form-check-label" for="u-32">
                                                    Tetap
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-11"
                                                        value="u-33" id="u-33">
                                                    <label class="form-check-label" for="u-33">
                                                    Menurun
                                                    </label>
                                                </div>
                                            </form>
                                ...
                                <div>
                                    <p>12. Setelah saya mempelajari tentang uap air di atmosfer bumi serta manfaatnya bagi kehidupan, kadar keyakinan saya bahwa keberadaan uap air di atmosfer bumi merupakan salah satu bentuk penjagaan Tuhan YME terhadap makhluknya agar bumi memiliki suhu yang hangat untuk dapat ditinggali.</p>
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-12"
                                                        value="u-34" id="u-34">
                                                    <label class="form-check-label" for="u-34">
                                                    Meningkat
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-12"
                                                        value="u-35" id="u-35">
                                                    <label class="form-check-label" for="u-35">
                                                    Tetap
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-12"
                                                        value="u-36" id="u-36">
                                                    <label class="form-check-label" for="u-36">
                                                    Menurun
                                                    </label>
                                                </div>
                                            </form>
                                ...
                                <div>
                                    <p>13. Setelah mempelajari adanya sifat anomali pada air, kadar keyakinan Saya  bahwa sifat anomali air merupakan sifat istimewa yang Tuhan YME tetapkan pada air sebagai bentuk perlindungan Tuhan Yme terhadap kehidupan makhluk hidup air ketika musim dingin tiba.</p>
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-13"
                                                        value="u-37" id="u-37">
                                                    <label class="form-check-label" for="u-37">
                                                    Meningkat
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-13"
                                                        value="u-38" id="u-38">
                                                    <label class="form-check-label" for="u-38">
                                                    Tetap
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-13"
                                                        value="u-39" id="u-39">
                                                    <label class="form-check-label" for="u-39">
                                                    Menurun
                                                    </label>
                                                </div>
                                            </form>
                                ...
                                <div>
                                    <p>14. Setelah saya mempelajari adanya sumber mata air tawar di pegunungan dan oasis di tanah gurun, kadar keyakinan saya bahwa mekanisme adanya air tanah yang dapat meuncul kepermukaan daam bentuk mata air maupun oasis merupakan bentuk perlindungan Tuhan YME terhadap kehidupan makhluk hidup yang tinggal di pegunungan dan padang pasir.</p>
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-14"
                                                        value="u-40" id="u-40">
                                                    <label class="form-check-label" for="u-40">
                                                    Meningkat
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-14"
                                                        value="u-41" id="u-41">
                                                    <label class="form-check-label" for="u-41">
                                                    Tetap
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-14"
                                                        value="u-42" id="u-42">
                                                    <label class="form-check-label" for="u-42">
                                                    Menurun
                                                    </label>
                                                </div>
                                            </form>
                                ...
                                <div>
                                    <p>15. Setelah saya mempelajari karakteristik titik lebur dan titik didih air,  kadar keyakinan Saya bahwa titik lebur air sebesar 0oC dan titik didih air sebesar 100<span>&#8451;</span>C pada tekanan 1 atm itu merupakan sesuatu yang telah diperhitungkan dengan akurat oleh Allah SWT untukkemudahan manusia:</p>
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-15"
                                                        value="u-43" id="u-43">
                                                    <label class="form-check-label" for="u-43">
                                                    Meningkat
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-15"
                                                        value="u-44" id="u-44">
                                                    <label class="form-check-label" for="u-44">
                                                    Tetap
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-15"
                                                        value="u-45" id="u-45">
                                                    <label class="form-check-label" for="u-45">
                                                    Menurun
                                                    </label>
                                                </div>
                                            </form>
                                ...
                                <div>
                                    <p>16. Setelah membaca bahan belajar elektronik tema Hidrosfer,  saya meyakini bahwa penurunan suhu secara linear seiring bertambahnya ketinggian pada lapisan troposfer  merupakan sesuatu yang telah Tuhan YME perhitungkan secara akurat:</p>
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-16"
                                                        value="u-46" id="u-46">
                                                    <label class="form-check-label" for="u-46">
                                                    Meningkat
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-16"
                                                        value="u-47" id="u-47">
                                                    <label class="form-check-label" for="u-47">
                                                    Tetap
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-16"
                                                        value="u-48" id="u-48">
                                                    <label class="form-check-label" for="u-48">
                                                    Menurun
                                                    </label>
                                                </div>
                                            </form>
                                ...
                                <div>
                                    <p>17. Setelah saya mempelajari, Ketepatan dan kekauratan fakta sains dengan apa yang Allah firmankan dalam Al-Qur’an, Kadar keyakinan saya bahwa Tuhan YME Maha benar dengan segala firman-Nya dalam kitab suci Al Quran:</p>
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-17"
                                                        value="u-49" id="u-49">
                                                    <label class="form-check-label" for="u-49">
                                                    Meningkat
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-17"
                                                        value="u-50" id="u-50">
                                                    <label class="form-check-label" for="u-50">
                                                    Tetap
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-17"
                                                        value="u-51" id="u-51">
                                                    <label class="form-check-label" for="u-51">
                                                    Menurun
                                                    </label>
                                                </div>
                                            </form>
                                ...
                                <div>
                                    <p>18. Setelah saya mempelajari bahwa fakta sains yang menunjukan bahwa segala bencana alam yang terjadi merupkan bentuk ketidakseimbangan alam semesta yang timbul akibat ulah manusia , Kadar keyakinan saya bahwa Tuhan YME Maha benar dengan segala firman-Nya yang memerntahkan manusia senantiasa menjaga dan melestarikan alam semesta:</p>
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-18"
                                                        value="u-52" id="u-52">
                                                    <label class="form-check-label" for="u-52">
                                                    Meningkat
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-18"
                                                        value="u-53" id="u-53">
                                                    <label class="form-check-label" for="u-53">
                                                    Tetap
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-18"
                                                        value="u-54" id="u-54">
                                                    <label class="form-check-label" for="u-54">
                                                    Menurun
                                                    </label>
                                                </div>
                                            </form>
                                ...
                                <div>
                                    <p>19. Setelah mempelajari reaksi pembentukan molekul air yang berasal dari Hidrogen (H<sub>2</sub>) dan Oksigen (O<sub>2</sub>) yang keduanya merupakan zat yang mudah terbakar namun seteleh bereaksi membentuk ikatan molekul ir (H<sub>2</sub>O) yang justru memiliki karakter menyegarkan, kadar keyakinan saya pembentuan molekul air bukan hanya tentang rekasi kimia saja tetapi merupakan bentuk kekuasaan Allah SWT dalam menundukan molekul-molekul tersebut sesuai yang dikehendaki-Nya:</p>
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-19"
                                                        value="u-55" id="u-55">
                                                    <label class="form-check-label" for="u-55">
                                                    Meningkat
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-19"
                                                        value="u-56" id="u-56">
                                                    <label class="form-check-label" for="u-56">
                                                    Tetap
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-19"
                                                        value="u-57" id="u-57">
                                                    <label class="form-check-label" for="u-57">
                                                    Menurun
                                                    </label>
                                                </div>
                                            </form>
                                ...
                                <div>
                                    <p>20. Setelah mempelajari proses terjadinya siklus hidrologi, kadar keyakinan saya bahwa pergerakan angin itu bukan hanya semata fenomena alam semata yang dapat timbul akibat beda tekanan, tetapi bentuk kekuasaan Allah SWT dalam menundukannya untuk menggerakkan awan ke arah yang dikehendaki-Nya</p>
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-20"
                                                        value="u-58" id="u-58">
                                                    <label class="form-check-label" for="u-58">
                                                    Meningkat
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-20"
                                                        value="u-59" id="u-59">
                                                    <label class="form-check-label" for="u-59">
                                                    Tetap
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="u-20"
                                                        value="u-60" id="u-60">
                                                    <label class="form-check-label" for="u-60">
                                                    Menurun
                                                    </label>
                                                </div>
                                            </form>
    ...
    function startTimer(duration, display) {
        ...
        interval = setInterval(function () {
            ...
            if (--timer < 0) {
                ...
                clearInterval(interval);
                $('#btn-mulai').attr('disabled',false);
            }
        }, 1000);
    }
    function intCount(){
        // clearInterval(interval);
        // var coutdown = 1 * 60, $timer = $('.timer');
        // $timer.text(coutdown);
        // interval = setInterval(function () {
        //     $timer.text(--coutdown);
        //     if (coutdown === 0) {
