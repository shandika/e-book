                        ...
                        <div class="overflow-auto" id="teks" style="height: 500px;">
                            ...
                            <div id="bagian-1-1">
                                ...
                                <div class="bg-primary">
                                    <p id="daftar-1-2" class="text-primary fw-bold">Check Previous Knowledge</p>
                                    <p>Sebelum melanjutkan pembahasan mengenai ikatan antar atom penyusun molekul air,
                                        masih
                                        ...
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" name="b1-1" type="radio"
                                                        value="b1-1" id="b1-1">
                                                    <label class="form-check-label" for="b1-1">
                                                        Ikatan yang terjadi karena adanya gaya tarik-menarik
                                                        elektrostatis
                                                        antara ion positif dan ion negatif dalam suatu senyawa
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" name="b1-1" type="radio"
                                                    ...
                                                    <label class="form-check-label" for="b1-2">
                                                        Ikatan yang terjadi ketika pemakaian bersama pasangan elektron
                                                        dari
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="b1-3">
                                                        Ikatan yang terbentuk karena adanya gaya tarik-menarik dari inti
                                                        atom dengan lautan elektron
                                                    </label>
                                                </div>
                                                <div class="container modal-footer">
                                                    <div class="row">
                                                        <div class="col">
                                                            <button class="btn btn-primary">Tampilkan Jawaban
                                                            </button>
                                                        </div>
                                                        <div class="col p-2">
                                                            <button type="submit" class="btn btn-primary">Mengunci
                                                                Jawaban
                                                            </button>
                                                        </div>
                                                    </div>
                                ...
                                <div class="bg-primary">
                                    <p id="daftar-1-4" class="fw-bold text-primary">Apply Knowledge</p>
                                    <p>Molekul air terbentuk dari atom oksigen yang memiliki nomor atom 8 dan atom
                                        hidrogen
                                    ...
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-2" value=""
                                                        id="b1-4">
                                                    <label class="form-check-label" for="b1-4">
                                                        Molekul H2O merupakan ikatan kovalen polar dimana atom O
                                                        memiliki
                                                        dipol positif dan atom H memiliki dipol negatif.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-2" value=""
                                                    ...
                                                    <label class="form-check-label" for="b1-5">
                                                        Molekul H2O merupakan ikatan kovalen polar dimana atom O
                                                        memiliki
                                                        dipol negatif dan atom H memiliki dipol positif.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-2" value=""
                                                    ...
                                                    <label class="form-check-label" for="b1-6">
                                                        Molekul H2O merupakan ikatan kovalen non-polar dimana pasangan
                                                        elektron yang digunakan bersama akan terdistribusi merata
                                                        sehingga
                                                        tidak akan terbentuk dipol positif maupun negatif.
                                                    </label>
                                                </div>
                                                <div class="container modal-footer">
                                                    <div class="row">
                            ...
                            <div id="bagian-1-2">
                                ...
                                <div class="bg-primary">
                                    <p id="daftar-1-8"class="fw-bold text-primary">Check Your Prior Knowledge</p>
                                    ...
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-3"
                                                        value="b1-7" id="b1-7">
                                                    <label class="form-check-label" for="b1-7">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-3"
                                                        value="b1-8" id="b1-8">
                                                    <label class="form-check-label" for="b1-8">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-3"
                                                        value="b1-9" id="b1-9">
                                                    <label class="form-check-label" for="b1-9">
                                                        Gaya antar molekul polar yang memiliki ikatan antara H dengan
                                                        atom-atom yang sangat elektronegatif seperti N, O, atau F.
                                                    </label>
                                                </div>
                                                <div class="container modal-footer">
                                                    <div class="row">
                                ...
                                <div class=bg-primary>
                                    <p id="daftar-1-10" class="fw-bold text-primary">Apply Knowledge</p>
                                    ...
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-4"
                                                        value="b1-10" id="b1-10">
                                                    <label class="form-check-label" for="b1-10">
                                                        Molekul H<sub>2</sub>O memiliki nilai Mr yang lebih besar
                                                        dibandingkan dengan molekul HF dan molekul NH<sub>3</sub>.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-4"
                                                        value="b1-11" id="b1-11">
                                                    <label class="form-check-label" for="b1-11">
                                                        Molekul H<sub>2</sub>O memiliki jumlah ikatan hidrogen yang
                                                        lebih
                                                        besar dibandingkan dengan molekul HF dan molekul NH<sub>3</sub>.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-4"
                                                        value="b1-12" id="b1-12">
                                                    <label class="form-check-label" for="b1-12">
                                                        Molekul H<sub>2</sub>O memiliki nilai Mr yang lebih besar
                                                        sekaligus
                                                        jumlah ikatan hidrogen yang lebih besar dibandingkan dengan
                                                        molekul
                                                        HF dan molekul NH<sub>3</sub>.
                                                    </label>
                                                </div>
                                                <div class="container modal-footer">
                                                    <div class="row">
                            ...
                            <div id="bagian-1-3">
                                ...
                                <div class="bg-primary">
                                    <p id="daftar-1-14" class="fw-bold text-primary">Check Your Prior Knowledge</p>
                                    ...
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-5"
                                                        value="b1-13" id="b1-13">
                                                    <label class="form-check-label" for="b1-13">
                                                        Campuran homogen yang terdiri dari zat pelarut dan zat terlarut
                                                        yang
                                                        bergabung dalam fase cair
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-5"
                                                        value="b1-14" id="b1-14">
                                                    <label class="form-check-label" for="b1-14">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-5"
                                                        value="b1-15" id="b1-15">
                                                    <label class="form-check-label" for="b1-15">
                                                        campuran heterogen dari dua zat atau lebih yang membentuk
                                                        campuran
                                                        kasar (memiliki fase antara cair dan padat)
                                                    </label>
                                                </div>
                                                <div class="container modal-footer">
                                                    <div class="row">
                                ...
                                <div class="bg-primary">
                                    <p id="daftar-1-16" class="text-primary">Apply Knowledge</p>
                                    <p>Jika air disebut sebagai pelarut universal, mengapa jika pasir dilarutkan kedalam
                                        air
                                        tidak dihasilkan larutan yang homogen.</p>
                                    <!-- Hal 29 b1-6 -->
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-6"
                                                        value="b1-16" id="b1-16">
                                                    <label class="form-check-label" for="b1-16">
                                                        Pasir memiliki partikel yang cukup besar dan cenderung berat
                                                        sehingga sulit terlarut dalam air
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-6"
                                                        value="b1-17" id="b1-17">
                                                    <label class="form-check-label" for="b1-17">
                                                        Pasir terdiri dari berbagai zat yang terikat secara kovalen yang
                                                        tidak mudah berikatan dengan molekul air
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-6"
                                                        value="b1-18" id="b1-18">
                                                    <label class="form-check-label" for="b1-18">
                                                        Partikel pasir tidak memiliki muatan listrik seperti ion
                                                        sehingga
                                                        tidak terjadi interaksi tarik menarik
                                                    </label>
                                                </div>
                                                <div class="container modal-footer">
                                                    <div class="row">
                            ...
                            <div id="bagian-1-4">
                                <div class="bg-light bg-gradient border-top border-bottom border-dark">
                                    <p id="daftar-1-19" class="text-primary">Refleksi Kognitif</p>
                                    ...
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-7"
                                                        value="b1-19" id="b1-19">
                                                    <label class="form-check-label" for="b1-19">
                                                        Saya memahami bahwa molekul air dibangun oleh satu atom
                                                        oksigen
                                                        (O<sub>2</sub>) yang terikat secara kovalen dengan dua atom
                                                        hidrogen
                                                        (H<sub>2</sub>) sehingga sering disebut juga sebagai molekul
                                                        H<sub>2</sub>O
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-7"
                                                        value="b1-20" id="b1-20">
                                                    <label class="form-check-label" for="b1-20">
                                                        Saya memahami bahwa pada ikatan molekul H<sub>2</sub>O, atom
                                                        oksigen
                                                        mempunyai Keelektronegatifan yang lebih besar daripada atom
                                                        hidrogen, sehingga ikatan O―H dalam molekul air bersifat
                                                        polar,
                                                        dengan oksigen mempunyai muatan parsial negatif (δ−) dan
                                                        hidrogen
                                                        mempunyai muatan parsial positif (δ+).
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-7"
                                                        value="b1-21" id="b1-21">
                                                    <label class="form-check-label" for="b1-21">
                                                        Saya memahami bahwa karena polaritasnya, air memiliki
                                                        kemampuan
                                                        melarutkan banyak molekul lain yang bersifat polar dan ionik
                                                        dibandingkan pelarut lain sehingga air disebut sebagai
                                                        pelarut
                                                        universal.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-7"
                                                        value="b1-22" id="b1-22">
                                                    <label class="form-check-label" for="b1-22">
                                                        Saya memahami bahwa karena polaritasnya, air memiliki
                                                        kemampuan
                                                        berikatan antara sesama molekul H<sub>2</sub>O melalui gaya
                                                        ikatan
                                                        Hidrogen sehingga menghasilkan gaya Kohesi dan memiliki
                                                        kemampuan
                                                        berikatan dengan molekul lain melalui ikatan van der waals
                                                        sehingga
                                                        menghasilkan gaya Adhesi.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-7"
                                                        value="b1-23" id="b1-23">
                                                    <label class="form-check-label" for="b1-23">
                                                        Saya memahami bahwa gaya Ikatan Hidrogen antar molekul air
                                                        (H<sub>2</sub>O) berpengaruh terhadap tegangan permukaan,
                                                        titik
                                                        lebur dan titik didih air.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-7"
                                                        value="b1-24" id="b1-24">
                                                    <label class="form-check-label" for="b1-24">
                                                        Setiap molekul H<sub>2</sub>O dapat membentuk maksimal 4
                                                        ikatan
                                                        hidrogen sehingga menyebabkan air memiliki titik didih yang
                                                        paling
                                                        tinggi dibanding ikatan hidrogen lainnya (100oC).
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-7"
                                                        value="b1-25" id="b1-25">
                                                    <label class="form-check-label" for="b1-25">
                                                        Saya memahami bahwa adanya gaya kohesi dan gaya adhesi pada
                                                        air
                                                        akan
                                                        menyebabkan munculnya sifat kapilaritas air
                                                    </label>
                                                </div>
                                                <div class="container modal-footer">
                                                    <div class="row">
                            ...
                            <div id="bagian-1-5">
                                <div class="bg-light bg-gradient border-top border-bottom border-dark">
                                    <p id="daftar-1-20" class="text-primary">Refleksi Spiritual</p>
                                    <p>Berilah tanda ceklis pada sikap spiritual yang anda yakini.</p>
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-8"
                                                        value="b1-26" id="b1-26">
                                                    <label class="form-check-label" for="b1-26">
                                                        Saya meyakini bahwa keberadaan air di bumi bukan merupakan hal
                                                        yang
                                                        kebetulan melainkan telah direncanakan oleh Allah SWT jauh
                                                        sebelum
                                                        penciptaan manusia yang kemudian diturunkan ke bumi pada waktu
                                                        dan
                                                        ukuran yang tepat untuk dapat menunjang unsur kehidupan di bumi.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-8"
                                                        value="b1-27" id="b1-27">
                                                    <label class="form-check-label" for="b1-27">
                                                        Saya meyakini bahwa sifat polaritas yang muncul dari ikatan
                                                        kovalen
                                                        molekul air merupakan desain yang telah Allah SWT tetapkan agar
                                                        air
                                                        memiliki sifat sebagai zat pelarut yang baik sehingga air dapat
                                                        digunakan untuk media pembersihan (mandi dan mencuci) dengan
                                                        cara
                                                        melarutkan zat-zat yang tidak dibutuhkan dan mengalirkannya ke
                                                        tempat pembuangan serta membantu makhluk hidup (seperti hewan
                                                        dan
                                                        manusia) untuk melarutkan zat yang berguna yang bagi tubuh
                                                        (melalui
                                                        aktivitas makan dan minum) dan mengedarkannya ke seluruh tubuh
                                                        melalui aliran darah.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-8"
                                                        value="b1-28" id="b1-28">
                                                    <label class="form-check-label" for="b1-28">
                                                        Saya meyakini bahwa sifat polaritas yang muncul dari ikatan
                                                        kovalen
                                                        molekul air merupakan desain yang telah Allah SWT tetapkan agar
                                                        air
                                                        memiliki kemampuan kapilaritas yang baik untuk menyebarkan
                                                        zat-zat
                                                        terlarut tersebut melalui mekanisme kohesi dan adhesi yang
                                                        sangat
                                                        bermanfaat dalam proses penyebaran unsur hara yang terlarut
                                                        dalam
                                                        tanah yang kemudian diserap oleh akar dan mengalir melalui
                                                        batang
                                                        dan ranting hingga dapat sampai pada daun tumbuhan.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-8"
                                                        value="b1-29" id="b1-29">
                                                    <label class="form-check-label" for="b1-29">
                                                        Saya memahami bahwa karena polaritasnya, air memiliki kemampuan
                                                        berikatan antara sesama molekul H<sub>2</sub>O melalui gaya
                                                        ikatan
                                                        Hidrogen sehingga menghasilkan gaya Kohesi dan memiliki
                                                        kemampuan
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b1-8"
                                                        value="b1-30" id="b1-30">
                                                    <label class="form-check-label" for="b1-30">
                                                        Saya meyakini bahwa ikatan hidrogen yang dimiliki oleh air
                                                        merupakan
                                                        desain yang telah Allah SWT tetapkan agar air memiliki titik
                                                        lebur
                                                        yang tinggi sehingga pada suhu udara normal air dapat tetap
                                                        berada
                                                        pada wujud cair yang sangat dibutuhkan makhluk hidup.
                                                    </label>
                                                </div>
                                                <div class="container modal-footer">
                                                    <div class="row">
                            ...
                            <div class="container mt-3">
                                    <form>
                                        <div class="mb-3">
                                            <textarea class="form-control" id="jawaban" rows="5" placeholder="Tulis jawaban di sini..."></textarea>
                                        </div>
                        ...
                        <div class="overflow-auto" id="teks" style="height: 500px;">
                            ...
                            <div id="bagian-2-1">
                                ...
                                <p>Air adalah senyawa yang penting bagi semua bentuk kehidupan yang diketahui sampai
                                    ...
                                    awan.</p>
                                <div class="bg-primary">
                                    <p id="daftar-2-2" class="fw-bold text-primary">Check Your Prior Knowledge</p>
                                    ...
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b2-1"
                                                        value="b2-1" id="b2-1">
                                                    <label class="form-check-label" for="b2-1">
                                                        Benda padat memiliki bentuk tetap, zat cair dan gas berubah
                                                        mengikuti tempat
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="b2-2">
                                                        Benda padat memiliki gaya antar molekul yang lebih kuat dari
                                                        cair
                                                        dan gas
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="b2-3">
                                                        Antar molekul benda padat dan cair rapat dan tidak memiliki
                                                        rongga
                                                        sedangkan pada gas memiliki rongga antar molekul.
                                                    </label>
                                                </div>
                                                <div class="container modal-footer">
                                                    <div class="row">
                                ...
                                <p>Karena suhu rata-rata bumi sebesar 14<span>&#8451;</span>, air dalam wujud uap jarang
                                    ...
                                    ada di bumi.</p>
                                <div class="bg-primary">
                                    <p id="daftar-2-4" class="text-primary">Apply Knowledge</p>
                                    ...
                                    <p>Menurut anda karakteristik zat cair yang manakah yang dimanfaatkan dalam membuat
                                        sistem hidrolik</p>
                                    <!-- Hal 44 B2-2 -->
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b2-2"
                                                        value="b2-4" id="b2-4">
                                                    <label class="form-check-label" for="b2-4">
                                                        Zat cair tidak memiliki ruang antar molekul dan volumenya
                                                        relatif
                                                        tetap
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b2-2"
                                                        value="b2-5" id="b2-5">
                                                    <label class="form-check-label" for="b2-5">
                                                        Zat cair memiliki ikatan molekul yang lebih kuat dan dapat
                                                        mengikuti
                                                        bentuk wadah
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b2-2"
                                                        value="b2-6" id="b2-6">
                                                    <label class="form-check-label" for="b2-6">
                                                        Zat cair dapat mengikuti bentuk wadah dan tidak dapat
                                                        dimampatkan
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b2-2"
                                                        value="b2-7" id="b2-7">
                                                    <label class="form-check-label" for="b2-7">
                                                        Ikatan antar molekul yang lemah membuat air dapat mengikuti
                                                        bentuk
                                                        wadah
                                                    </label>
                                                </div>
                            ...
                            <div id="bagian-2-2">
                                ...
                                <div class="bg-primary">
                                    <p id="daftar-2-6" class="text-primary">Check Your Prior Knowledge</p>
                                    <p>Masih ingatkah anda bagaimana perilaku atom/molekul suatu zat ketika ditambahkan
                                        energi kalor kepadanya?</p>
                                    <!-- Hal 46 B2-3 -->
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b2-3"
                                                        value="b2-8" id="b2-8">
                                                    <label class="form-check-label" for="b2-8">
                                                        Atom/molekul akan kehilangan energi sehingga akan bergerak acak
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b2-3"
                                                        value="b2-9" id="b2-9">
                                                    <label class="form-check-label" for="b2-9">
                                                        Atom/molekul akan mendapat tambahan energi sehingga molekul akan
                                                        saling menjauh satu sama lain
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b2-3"
                                                        value="b2-10" id="b2-10">
                                                    <label class="form-check-label" for="b2-10">
                                                        Atom/molekul akan mendapat tambahan energi sehingga akan
                                                        bergerak
                                                        acak ke segala arah
                                                    </label>
                                                </div>
                                ...
                                <div class="bg-primary">
                                    <p id="daftar-2-8" class="text-primary">Apply Knowledge</p>
                                    ...
                                    <p>Manakah pernyataan berikut yang benar mengenai dry ice saat dikeluarkan dari
                                        mesin
                                        pendingin dan langsung diletakan pada tempat dengan suhu kamar
                                        (20<span>&#8451;</span>-25<span>&#8451;</span>) pada tekanan 1 atm.</p>
                                    <!-- Hal 51 B2-4 -->
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b2-4"
                                                        value="b2-11" id="b2-11">
                                                    <label class="form-check-label" for="b2-11">
                                                        Dry es (padat) akan langsung berubah menjadi gas tanpa melewati
                                                        wujud cair terlebih dahulu
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b2-43"
                                                        value="b2-12" id="b2-12">
                                                    <label class="form-check-label" for="b2-12">
                                                        Dry es (padat) terlebih dahulu berubah menjadi cair kemudian
                                                        secara
                                                        cepat langsung berubah menjadi gas
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b2-4"
                                                        value="b2-13" id="b2-13">
                                                    <label class="form-check-label" for="b2-13">
                                                        Dry es (padat) terlebih dahulu akan mengalami kenaikan tekanan
                                                        sehingga secara cepat langsung berubah menjadi gas
                                                    </label>
                                                </div>
                                                <div class="container modal-footer">
                                                    <div class="row">
                            ...
                            <div id="bagian-2-4">
                                ...
                                <div class="bg-primary">
                                    <p id="daftar-2-15" class="text-primary">Apply Knowledge</p>
                                    <p>Saat kita meletakan botol minuman dingin pada suatu ruangan, lama kelamaan kita
                                        akan
                                        melihat tetes-tetes embun di permukaan luar botol tersebut. Menurutmu dari mana
                                        embun tersebut berasal?</p>
                                    <!-- Hal 64 b2-5 -->
                                    <div class="container mt-5">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col">
                                                <div class="container">
                                                    <form>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="b2-5"
                                                                value="b2-14" id="b2-14">
                                                            <label class="form-check-label" for="b2-14">
                                                                Air dingin dalam botol menguap dan menembus botol
                                                                sehingga
                                                                menghasilkan embun di permukaan luar botol
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="b2-5"
                                                                value="b2-15" id="b2-15">
                                                            <label class="form-check-label" for="b2-15">
                                                                Es yang menempel pada permukaan botol meleleh karena
                                                                udara
                                                                panas sehingga menghasilkan tetes embun
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="b2-5"
                                                                value="b2-16" id="b2-16">
                                                            <label class="form-check-label" for="b2-16">
                                                                Uap air yang tercampur dengan udara di sekitar botol
                                                                mengalami pengembunan karena kalor di udara diserap
                                                                botol
                                                                dingin
                                                            </label>
                                                        </div>
                                                        <div class="container modal-footer">
                                                            <div class="row">
                                                                ...
                                                                <div class="col p-2">
                                                                    <button type="submit"
                                                                        class="btn btn-primary">Mengunci
                                                                        Jawaban
                                                                    </button>
                                                                </div>
                                                            </div>
                            ...
                            <div id="bagian-2-5">
                                ...
                                <div class="bg-primary">
                                    <p id="daftar-2-18" class="text-italic text-primary">Apply Knowledge</p>
                                    ...
                                    <p>Manakah pernyataan berikut yang benar terkait dengan peristiwa menyublim pada
                                        kamper/kapur barus</p>
                                    <!-- Hal 68 B2-6 -->
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b2-6"
                                                        value="b2-17" id="b2-17">
                                                    <label class="form-check-label" for="b2-17">
                                                        Karena kamper tersusun dari molekul Naphthalene yang berikatan
                                                        van
                                                        der waals jenis dispersi gaya london maka dengan sedikit energi
                                                        kalor pada suhu kamar (20-25°C) , akan mampu merubah kamper
                                                        padat
                                                        menjadi gas
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b2-6"
                                                        value="b2-18" id="b2-18">
                                                    <label class="form-check-label" for="b2-18">
                                                        Bau kamper yang tercium ketika kamper dikeluarkan dari plastik
                                                        pembungkusnya merupakan bukti bahwa kamper mengalami proses
                                                        menyublim (berubah wujud dari padat ke gas)
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b2-6"
                                                        value="b2-19" id="b2-19">
                                                    <label class="form-check-label" for="b2-19">
                                                        Karena kamper memiliki titik lebur 78.2 °C dan titik didih
                                                        217.97 °C
                                                        maka proses sublimasi (perubahan wujud padat ke gas) pada kamper
                                                        hanya akan terjadi pada suhu yang tinggi.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b2-6"
                                                        value="b2-20" id="b2-20">
                                                    <label class="form-check-label" for="b2-20">
                                                        Ketika kamper disimpan pada udara terbuka, lama kelamaan akan
                                                        mengecil karena molekul kamper secara perlahan akan akan berubah
                                                        menjadi bubuk kristal yang hilang terbawa angin.
                                                    </label>
                                                </div>
                                                <div class="container modal-footer">
                                                    <div class="row">
                            ...
                            <div id="bagian-2-6">
                                <div class="bg-light bg-gradient border-top border-bottom border-dark">
                                    <p id="daftar-2-21" class="text-primary">Refleksi Kognitif</p>
                                    <p>Berilah tanda ceklis pada konsep-konsep yang sudah anda pahami.</p>
                                    <!-- Hal 74 b2-7 -->
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b2-7"
                                                        value="b2-21" id="b2-21">
                                                    <label class="form-check-label" for="b2-21">
                                                        Saya memahami bahwa suhu rata-rata yang dimiliki permukaan bumi
                                                        memungkinkan air di permukaan bumi dapat berada dalam 3 wujud
                                                        (padat, cair dan gas)
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b2-7"
                                                        value="b2-22" id="b2-22">
                                                    <label class="form-check-label" for="b2-22">
                                                        Saya memahami bahwa perbedaan mendasar air dalam wujud padat,
                                                        cair
                                                        dan gas adalah pada ikatan antar molekul yang terbentuk. Air
                                                        pada
                                                        wujud padat membentuk struktur kristalin sedangkan air dalam
                                                        wujud
                                                        cair membentuk ikatan amorf, adapun pada wujud gas hampir tidak
                                                        terjadi ikatan antar molekulnya.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b2-7"
                                                        value="b2-23" id="b2-23">
                                                    <label class="form-check-label" for="b2-23">
                                                        Saya memahami bahwa perubahan wujud pada zat cair dipengaruhi
                                                        oleh
                                                        suhu dan tekanan.dimana kenaikan suhu dan tekanan air akan
                                                        menyebabkan kenaikan energi kinetik partikel air sehingga setiap
                                                        molekul air dapat melepaskan diri dari ikatan antar molekul.
                                                        Sebaliknya penurunan suhu dan tekanan air akan menyebabkan
                                                        kenaikan
                                                        energi kinetik partikel air sehingga setiap molekul air dapat
                                                        melepaskan diri dari ikatan antar molekul </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b2-7"
                                                        value="b2-24" id="b2-24">
                                                    <label class="form-check-label" for="b2-24">
                                                        Saya memahami bahwa perubahan wujud melebur, menguap dan
                                                        menyublim
                                                        termasuk dalam proses eksotermik dimana dalam perubahan wujud
                                                        tersebut harus melibatkan penambahan kalor.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b2-7"
                                                        value="b2-25" id="b2-25">
                                                    <label class="form-check-label" for="b2-25">
                                                        Saya memahami bahwa perubahan wujud membeku, mengembun dan
                                                        deposisi
                                                        termasuk dalam proses endotermik dimana dalam perubahan wujud
                                                        tersebut harus melibatkan pelepasan kalor.
                                                    </label>
                                                </div>
                                                <div class="container modal-footer">
                                                    <div class="row">
                            ...
                            <div id="bagian-2-7">
                                <div class="bg-light bg-gradient border-top border-bottom border-dark">
                                    <p id="daftar-2-22" class="text-primary">Refleksi Spiritual</p>
                                    <p>Berilah tanda ceklis pada sikap spiritual yang anda yakini.</p>
                                    <!-- Hal 75 b2-8 -->
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b2-8"
                                                        value="b2-26" id="b2-26">
                                                    <label class="form-check-label" for="b2-26">
                                                        Saya meyakini bahwa keberadaan air di bumi dalam 3 wujud bukan
                                                        merupakan hal yang kebetulan melainkan telah direncanakan oleh
                                                        Allah
                                                        SWT dimana setiap wujud zat cair tersebut memiliki peran
                                                        masing-masing untuk dapat menunjang unsur kehidupan di bumi.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b2-8"
                                                        value="b2-27" id="b2-27">
                                                    <label class="form-check-label" for="b2-27">
                                                        Saya meyakini bahwa sifat anomali air merupakan sifat istimewa
                                                        yang
                                                        Allah SWT berikan pada air sebagai bentuk kasih sayang-Nya
                                                        terhadap
                                                        kehidupan makhluk hidup darat dan air ketika musim dingin tiba.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b2-8"
                                                        value="b2-28" id="b2-28">
                                                    <label class="form-check-label" for="b2-28">
                                                        Saya meyakini bahwa keberadaan air dalam wujud gas (uap air) di
                                                        atmosfer bumi merupakan salah satu bentuk penjagaan Allah
                                                        terhadap
                                                        makhluknya agar bumi memiliki suhu yang hangat untuk dapat
                                                        ditinggali. </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b2-8"
                                                        value="b2-29" id="b2-29">
                                                    <label class="form-check-label" for="b2-29">
                                                        Saya meyakini bahwa adanya hujan salju merupakan mekanisme yang
                                                        telah Allah tetapkan untuk pembersihan atmosfer dan penyedian
                                                        cadangan air tawar bagi bumi ketika di suatu daerah dengan 4
                                                        musim
                                                        yang tidak memungkinkan terjadinya hujan air secara konsisten.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b2-8"
                                                        value="b2-30" id="b2-30">
                                                    <label class="form-check-label" for="b2-30">
                                                        Saya meyakini bahwa adanya embun merupakan mekanisme yang telah
                                                        Allah tetapkan untuk membuktikan ke-Maha Kuasaan Allah untuk
                                                        mmeurnikan air secara alami serta untuk menjaga kelembaban
                                                        tumbuhan
                                                        dan tanah ditempat bebas dimana tidak banyak mendapat perawatn
                                                        dan
                                                        prhatian dari manusia.
                                                    </label>
                                                </div>
                                                <div class="container modal-footer">
                                                    <div class="row">
                        ...
                        <div class="overflow-auto" id="teks" style="height: 500px;">
                            ...
                            <div id="bagian-3-1">
                                ...
                                <p>Air adalah senyawa yang penting bagi semua bentuk kehidupan yang diketahui sampai
                                    ...
                                    awan. </p>
                                <div class="bg-primary">
                                    <p id="daftar-3-2" class="text-primary">Check Your Prior Knowledge</p>
                                    <p>Menurutmu bagaimanakan jumlah total air di bumi, apakah tetap, bertambah atau
                                        berkurang?</p>
                                    <!-- Hal 78 3B-1 -->
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-1"
                                                        value="b3-1" id="b3-1">
                                                    <label class="form-check-label" for="b3-1">
                                                        Jumlah air di bumi relatif tetap karena jumlah air yang hilang
                                                        keluar angkasa hampir sebanding dengan air yang masuk ke bumi
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-1"
                                                        value="b3-2" id="b3-2">
                                                    <label class="form-check-label" for="b3-2">
                                                        Jumlah air di bumi selalu tetap karena tidak mengalami
                                                        penambahan
                                                        maupun pengurangan
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-1"
                                                        value="b3-3" id="b3-3">
                                                    <label class="form-check-label" for="b3-3">
                                                        Jumlah air di bumi selalu mengalami penambahan yang bersumber
                                                        dari
                                                        air hujan yang turun </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-1"
                                                        value="b3-4" id="b3-4">
                                                    <label class="form-check-label" for="b3-4">
                                                        Jumlah air di bumi mengalami pengurangan karena sebagian menguap
                                                        keluar angkasa karena sinar matahari
                                                    </label>
                                                </div>
                                                <div class="container modal-footer">
                                                    <div class="row">
                                ...
                                <div class="bg-primary">
                                    <p id="daftar-3-4" class="text-primary">Apply Knowledge</p>
                                    <p>Salah satu upaya yang dilakukan manusia untuk mengumpulkan sejumlah debit air
                                        tawar
                                        dalam jumlah yang besar adalah melalui pembuatan bendungan. Bendungan dapat
                                        bermanfaat dalam mengendalikan banjir dan menjadi penyedia cadangan air untuk
                                        mengantisipasi kekeringan pada musim kemarau. Sisi lain keberadaan bendungan
                                        juga
                                        dapat dimanfaatkan untuk pembangunan pembangkit listrik dan tujuan rekreasi.
                                        Menurutmu apakah apakah pembuatan bendungan ini akan mempengaruhi laju dan
                                        keseimbangan siklus hidrologi?</p>
                                    <!-- Hal 81 B3-2 -->
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="b3-2"
                                                        value="b3-5" id="b3-5">
                                                    <label class="form-check-label" for="b3-5">
                                                        Pembendungan air sungai akan membantu melambatnya siklus
                                                        hidrologi
                                                        di daratan sehingga air tawar dapat dimanfaatkan lebih banyak
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="b3-2"
                                                        value="b3-6" id="b3-6">
                                                    <label class="form-check-label" for="b3-6">
                                                        Pembendungan air sungai mengganggu laju siklus hidrologi
                                                        sehingga
                                                        pasokan air tawar akan terhambat
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="b3-2"
                                                        value="b3-7" id="b3-7">
                                                    <label class="form-check-label" for="b3-7">
                                                        Pembendungan air sungai memiliki dampak positif untuk dapat
                                                        dimanfaatkan manusia namun memiliki dampak negatif bagi
                                                        lingkungan
                                                    </label>
                                                </div>
                                                <div class="container modal-footer">
                            ...
                            <div id="bagian-3-2">
                                ...
                                <div class="bg-primary">
                                    <p id="daftar-3-9" class="text-primary">Apply Knowledge</p>
                                    <p>Pada musim panas, sinar matahari dengan intensitas yang lebih tinggi memungkinkan
                                        terjadinya proses evaporasi/penguapan yang lebih banyak daripada musim dingin,
                                        tapi
                                        mengapa pada musim panas justru tidak banyak awan yang terbentuk?</p>
                                    <!-- Hal -->
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-3"
                                                        value="b3-8" id="b3-8">
                                                    <label class="form-check-label" for="b3-8">
                                                        Pernyataan tersebut keliru, karena pada musim panas awan tetap
                                                        terbentuk dengan banyak
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-3"
                                                        value="b3-9" id="b3-9">
                                                    <label class="form-check-label" for="b3-9">
                                                        Pembentukan awan tidak ada kaitannya dengan panas sinar
                                                        matahari,
                                                        pada kondisi apapun awan tetap akan terbentuk
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-3"
                                                        value="b3-10" id="b3-10">
                                                    <label class="form-check-label" for="b3-10">
                                                        Tidak semua uap air di udara dapat membentuk awan, diperlukan
                                                        proses
                                                        pendinginan agar uap air di udara dapat menjadi awan </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-3"
                                                        value="b3-11" id="b3-11">
                                                    <label class="form-check-label" for="b3-11">
                                                        Untuk dapat membentuk awan, uap air di udara harus berada pada
                                ...
                                <p>Meskipun transpirasi pada dasarnya merupakan proses yang diadopsi oleh tanaman, namun
                                    ...
                                    uap air per tahun.</p>
                                <div class="bg-primary">
                                    <p id="daftar-3-11" class="text-primary">Apply Knowledge</p>
                                    <p>Bagaimana proses penggundulan hutan atau deforestasi dapat mempengaruhi siklus
                                        hidrologi?</p>
                                    <!-- Hal 96 b3-4 -->
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-4"
                                                        value="b3-12" id="b3-12">
                                                    <label class="form-check-label" for="b3-12">
                                                        Pengurangan jumlah vegetasi tumbuhan dapat mengurangi produksi
                                                        oksigen yang akan berpengaruh pada siklus hidrologi
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-4"
                                                        value="b3-13" id="b3-13">
                                                    <label class="form-check-label" for="b3-13">
                                                        Tumbuhan merupakan penyumbang uap air di atmosfer, menggunduli
                                                        hutan
                                                        berarti mengurangi sumber air tawar di atmosfer
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-4"
                                                        value="b3-14" id="b3-14">
                                                    <label class="form-check-label" for="b3-14">
                                                        Tumbuhan menjaga kelembaban tanah dengan cara mengikat air
                                                        tanah,
                                                        penggundulan hutan akan menyebabkan tanah menjadi gersang
                                                    </label>
                                                </div>
                                                <div class="container modal-footer">
                                                    <div class="row">
                                ...
                                <div class="bg-primary">
                                    <p id="daftar-3-13" class="text-primary">Apply Knowledge</p>
                                    <p>Karena awan merupakan akumulasi dari tetes-tetes air yang terbentuk pada proses
                                        kondensasi, maka akumulasi tetes air itu akan menjadikan awan memiliki massa
                                        yang
                                        cukup besar. Beberapa penelitian menunjukan hasil pengukuran massa awan yang
                                        kecil
                                        saja hampir mencapai 2 ton (hampir setara dengan dua ekor gajah dewasa). Namun
                                        dengan massa seberat itu mengapa awan dapat tetap melayang di atmosfer?</p>
                                    <!-- Hal 98 b3-5 -->
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-5"
                                                        value="b3-15" id="b3-15">
                                                    <label class="form-check-label" for="b3-15">
                                                        Pengurangan jumlah vegetasi tumbuhan dapat mengurangi produksi
                                                        oksigen yang akan berpengaruh pada siklus hidrologi
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-5"
                                                        value="b3-16" id="b3-16">
                                                    <label class="form-check-label" for="b3-16">
                                                        Tumbuhan merupakan penyumbang uap air di atmosfer, menggunduli
                                                        hutan
                                                        berarti mengurangi sumber air tawar di atmosfer
                                                    </label>
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-5"
                                                        value="b3-17" id="b3-17">
                                                    <label class="form-check-label" for="b3-17">
                                                        Tumbuhan menjaga kelembaban tanah dengan cara mengikat air
                                                        tanah,
                                                        penggundulan hutan akan menyebabkan tanah menjadi gersang
                                                    </label>
                                ...
                                <div class="bg-primary">
                                    <p id="daftar-3-15" class="text-primary">Apply Knowledge</p>
                                    <p>Terjadinya angin darat dan angin laut memiliki hubungan dengan terjadinya arus
                                        konveksi dan adveksi. Menurut anda bagaimana keterkaitan antara terjadinya angin
                                        darat dan angin laut dengan arus konveksi dan adveksi?</p>
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-6"
                                                        value="b3-18" id="b3-18">
                                                    <label class="form-check-label" for="b3-18">
                                                        Terjadinya angin darat dan angin laut memiliki kesesuaian dengan
                                                        arah arus adveksi dingin.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-6"
                                                        value="b3-19" id="b3-19">
                                                    <label class="form-check-label" for="b3-19">
                                                        Terjadinya angin darat dan angin laut memiliki kesesuaian dengan
                                                        arah arus adveksi panas.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-6"
                                                        value="b3-20" id="b3-20">
                                                    <label class="form-check-label" for="b3-20">
                                                        Terjadinya angin darat dan angin laut memiliki kesesuaian dengan
                                                        arah arus konveksi dingin.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-6"
                                                        value="b3-21" id="b3-21">
                                                    <label class="form-check-label" for="b3-21">
                                                        Terjadinya angin darat dan angin laut memiliki kesesuaian dengan
                                                        arah arus konveksi panas.
                                                    </label>
                                                </div>
                                                <div class="container modal-footer">
                                                    <div class="row">
                                ...
                                <div class="bg-primary">
                                    <p id="daftar-3-17" class=text-primary>Apply Knowledge</p>
                                    <p>Curah hujan selalu berupa air tawar, meskipun air tersebut berasal dari laut..
                                        Pada
                                        saat proses presipitasi, garam laut tidak menguap bersama air, sehingga hanya
                                        air
                                        murni saja yang jatuh sebagai tetes hujan. Namun sering kita mendengar istilah
                                        hujan
                                        asam yang berbahaya bagi manusia, dapatkah kamu menjelaskan bagaimana munculnya
                                        hujan asam tersebut?</p>
                                    <!-- Hal b3-7 -->
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" nmae="b3-7"
                                                        value="b3-22" id="b3-22">
                                                    <label class="form-check-label" for="b3-22">
                                                        Air hujan membawa larutan asam yang berasal dari air laut dan
                                                        penguapan tanah.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" nmae="b3-7"
                                                        value="b3-23" id="b3-23">
                                                    <label class="form-check-label" for="b3-23">
                                                        Air hujan bereaksi dengan gas asam yang berada di atmosfer yang
                                                        berasal dari asap pabrik dan kendaraan
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" nmae="b3-7"
                                                        value="b3-24" id="b3-24">
                                                    <label class="form-check-label" for="b3-24">
                                                        Saat air hujan jatuh menyentuh tanah, Air hujan bereaksi dengan
                                                        tanah yang memiliki kandungan asam yang tinggi
                                                    </label>
                                                </div>
                                                <div class="container modal-footer">
                                                    <div class="row">
                                ...
                                <br>
                                <div class="bg-primary">
                                    <p id="daftar-3-19" class="text-primary">Apply Knowledge</p>
                                    <p>Dapatkah anda menjelaskan apa yang menyebabkan terjadinya banjir, tanah longsor
                                        dan
                                        kekeringan tanah ditinjau dari proses infiltrasi dan surface runoff?</p>
                                    <!-- hal b3-8 -->
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-8"
                                                        value="b3-25" id="b3-25">
                                                    <label class="form-check-label" for="b3-25">
                                                        Tanah yang tidak mampu melakukan proses infiltrasi dengan baik
                                                        akan
                                                        menyebabkan air lebih banyak bergerak di permukaan (surface
                                                        runoff)
                                                        sehingga akan terjadi longsor dan banjir.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-8"
                                                        value="b3-26" id="b3-26">
                                                    <label class="form-check-label" for="b3-26">
                                                        Jika air hujan yang turun ke tanah semuanya mengalami proses
                                                        infiltrasi secara cepat tanpa ada sedikitpun yang bergerak di
                                                        permukaan maka akan terjadi peristiwa kekeringan
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-8"
                                                        value="b3-27" id="b3-27">
                                                    <label class="form-check-label" for="b3-27">
                                                        Jika tanah terlalu lembek maka proses infiltrasi akan
                                                        berlangsung
                                                        dengan sangat cepat yang mengakibatkan tanah menjadi longsor dan
                                                        banjir.
                                                    </label>
                                                </div>
                                                <div class="container modal-footer">
                                ...
                                <div class="bg-primary">
                                    <p id="daftar-3-21" class="text-primary">Apply Knowledge</p>
                                    <p>Menurut anda apakah muka air tanah akan dapat mengalami kekosongan hingga tidak
                                        ada
                                        lagi air yang dapat disedot oleh mesin pompa dari bawah tanah?</p>
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-9"
                                                        value="b3-28" id="b3-28">
                                                    <label class="form-check-label" for="b3-28">
                                                        Jika penyedotan air tanah dilakukan tanpa terkendali maka pada
                                                        suatu
                                                        saat air tanah akan kosong.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-9"
                                                        value="b3-29" id="b3-29">
                                                    <label class="form-check-label" for="b3-29">
                                                        Air tanah tidak akan pernah pengurangan namun dapat menurun
                                                        kualitasnya
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-9"
                                                        value="b3-30" id="b3-30">
                                                    <label class="form-check-label" for="b3-30">
                                                        Air tanah mungkin dapat mengalami penurunan jika air yang
                                                        meresap ke
                                                        tanah berkurang, namun tidak akan sampai kosong
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-9"
                                                        value="b3-31" id="b3-31">
                                                    <label class="form-check-label" for="b3-31">
                                                        Air tanah akan mengalami kekosongan pad amusim kemarau yang
                                                        ditandai
                                                        dengan mengeringnya permukaan tanah
                                                    </label>
                                                </div>
                                                <div class="container modal-footer">
                                                    <div class="row">
                            ...
                            <div id="bagian-3-3">
                                ...
                                <p>Berdasarkan tabel diatas terlihat bahwa siklus panjang memiliki proses yang kompleks
                                    ...
                                    sekalipun.</p>
                                <div class="bg-primary">
                                    <p id="daftar-3-28" class="text-primary">Apply Knowledge</p>
                                    <p>Kita mengetahui bahwa hujan air (rain) dapat terjadi pada siklus pendek maupun
                                        siklus
                                        sedang, sedangkan hujan salju (snow) hanya mungkin terjadi pada siklus panjang.
                                        Namun kita juga mengetahui bahwa selain hujan air (rain) dan hujan salju (snow),
                                        kita juga terkadang menemukan hujan es (Sleet) dan hujan beku (Freezing Rain),
                                        termasuk kedalam siklus yang manakah proses terjadinya hujan es dan hujan beku?
                                    </p>
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-10"
                                                        value="b3-32" id="b3-32">
                                                    <label class="form-check-label" for="b3-32">
                                                        Hujan es dipengaruhi oleh suhu dan kelembaban atmosfer sehingga
                                                        dapat terjadi baik pada siklus sedang maupun siklus panjang
                                                        sedangkan hujan beku hanya mungkin terjadi didaerah yang dingin
                                                        sekali sehingga hanya mungkin terjadi pada siklus panjang.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-10"
                                                        value="b3-33" id="b3-33">
                                                    <label class="form-check-label" for="b3-33">
                                                        Baik hujan es dan hujan beku dipengaruhi oleh suhu dan
                                                        kelembaban
                                                        atmosfer sehingga dapat terjadi baik pada siklus sedang maupun
                                                        siklus panjang
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-10"
                                                        value="b3-34" id="b3-34">
                                                    <label class="form-check-label" for="b3-34">
                                                        Untuk dapat terjadinya hujan es dan hujan beku dibutuhkan suhu
                                                        daratan yang sangat rendah sehingga kedua jenis hujan ini hanya
                                                        mungkin terjadi pada siklus panjang.
                                                    </label>
                                                </div>
                                                <div class="container modal-footer">
                                                    <div class="row">
                            ...
                            <div id="bagian-3-4">
                                <div class="bg-primary">
                                    <p id="daftar-3-31" class="text-primary">Refleksi Kognitif</p>
                                    <p>Berilah tanda ceklis pada konsep-konsep yang sudah anda pahami.</p>
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-11"
                                                        value="b3-35" id="b3-35">
                                                    <label class="form-check-label" for="b3-35">
                                                        Saya memahami bahwa Air di bumi dapat berbentuk air tawar di
                                                        daratan
                                                        sebagai sungai dan danau, di kutub dan dataran tinggi sebagai
                                                        lapisan es dan gletser, di tanah sebagai kelembaban tanah dan
                                                        air
                                                        bawah tanah, di udara sebagai uap air, dan bahkan di dalam
                                                        makhluk
                                                        hidup seperti tumbuhan, hewan dan manusia sebagai media
                                                        metabolisme.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-11"
                                                        value="b3-36" id="b3-36">
                                                    <label class="form-check-label" for="b3-36">
                                                        Saya memahami bahwa Siklus air merupakan istilah yang merujuk
                                                        pada
                                                        pergerakan air yang terus menerus di dalam bumi dan atmosfer.
                                                        Proses
                                                        penting dalam siklus air meliputi evaporasi , transpirasi ,
                                                        kondensasi , presipitasi , dan runoff.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-11"
                                                        value="b3-37" id="b3-37">
                                                    <label class="form-check-label" for="b3-37">
                                                        Saya memahami bahwa evaporasi adalah proses penguapan air pada
                                                        permukaan yang memiliki bentangan air dan juga pada benda padat
                                                        yang
                                                        mengandung air ke atmosfer.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-11"
                                                        value="b3-38" id="b3-38">
                                                    <label class="form-check-label" for="b3-38">
                                                        Saya memahami bahwa transpirasi merupakan tahapan penguapan air
                                                        yang
                                                        bersumber dari jaringan makhluk hidup terutama tumbuhan.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-11" value=""
                                                        id="b3-39">
                                                    <label class="form-check-label" for="b3-39">
                                                        Saya memahami bahwa Kondensasi adalah proses dimana uap air di
                                                        udara
                                                        diubah menjadi air cair; itu kebalikan dari penguapan.
                                                        Kondensasi
                                                        sangat penting dalam siklus air karena bertanggung jawab atas
                                                        pembentukan awan.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-11"
                                                        value="b3-40" id="b3-40">
                                                    <label class="form-check-label" for="b3-40">
                                                        Saya memahami bahwa Presipitasi adalah cairan atau air beku yang
                                                        terbentuk di atmosfer dan jatuh kembali ke bumi. Muncul dalam
                                                        berbagai bentuk, seperti hujan, hujan es, dan salju.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-11"
                                                        value="b3-41" id="b3-41">
                                                    <label class="form-check-label" for="b3-41">
                                                        Saya memahami bahwa Infiltrasi adalah proses dimana curah hujan
                                                        atau
                                                        air meresap ke dalam tanah di bawah permukaan dan berpindah ke
                                                        batuan melalui celah-celah dan ruang pori-pori sedangkan Surface
                                                        Run
                                                        off atau Limpasan permukaan adalah aliran air yang tidak
                                                        terbatas di
                                                        atas permukaan tanah, yang terjadi ketika kelebihan air hujan
                                                        atau
                                                        air lelehan salju tidak dapat lagi meresap dengan cepat ke dalam
                                                        tanah.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-11"
                                                        value="b3-42" id="b3-42">
                                                    <label class="form-check-label" for="b3-42">
                                                        Saya memahami bahwa Collection adalah saat air yang jatuh dari
                                                        awan
                                                        sebagai hujan, salju atau es terkumpul di lautan, sungai dan
                                                        danau,
                                                        serta sebagian besar menyusup (meresap) ke dalam tanah dan
                                                        terkumpul
                                                        sebagai air tanah.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-11"
                                                        value="b3-43" id="b3-43">
                                                    <label class="form-check-label" for="b3-43">
                                                        Saya memahami bahwa proses Siklus air pendek meliputi: Air laut
                                                        menguap kemudian melalui proses kondensasi berubah menjadi tetes
                                                        awan. Tetes awan kemudian menjatuhkan tetes hujan kembali ke
                                                        laut.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-11"
                                                        value="b3-44" id="b3-44">
                                                    <label class="form-check-label" for="b3-44">
                                                        Saya memahami bahwa proses siklus air sedang meliputi : Air laut
                                                        menguap dan dibawa oleh angin menuju daratan dan melalui proses
                                                        kondensasi berubah menjadi awan dan jatuh sebagai hujan di darat
                                                        kemudian meresap ke dalam tanah dan kemudian dikembalikan ke
                                                        laut
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-11"
                                                        value="b3-45" id="b3-45">
                                                    <label class="form-check-label" for="b3-45">
                                                        Saya memahami bahwa proses siklus air panjang meliputi: Air laut
                                                        diuapkan, setelah itu awan melalui proses kondensasi, kemudian
                                                        terbawa angin ke dataran tinggi ke pedalaman dan terjadilah
                                                        salju
                                                        atau es di pegunungan tinggi. Balok-balok es mengendap di puncak
                                                        gunung dan karena gravitasi meluncur ke tempat yang lebih
                                                        rendah,
                                                        gletser yang mencair terbentuk dan mengalir melalui sungai
                                                        kembali
                                                        ke laut.
                                                    </label>
                                                </div>
                            ...
                            <div id="bagian-3-5">
                                <div class="border-top border-bottom border-dark">
                                    <p id="daftar-3-32" class="text-primary">Refleksi Spiritual</p>
                                    <p>Berilah tanda ceklis pada sikap spiritual yang anda yakini.</p>
                                    <div class="col-12">
                                        <div class="container">
                                            <form>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-12"
                                                        value="b3-46" id="b3-46">
                                                    <label class="form-check-label" for="b3-46">
                                                        Saya meyakini bahwa adanya mekanisme siklus hidrologi merupakan
                                                        salah satu tanda keagungan Allah SWT sebagai Tuhan yang Maha
                                                        Memelihara dan menjaga makhluk-Nya.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-12"
                                                        value="b3-47" id="b3-47">
                                                    <label class="form-check-label" for="b3-47">
                                                        Saya meyakini bahwa adanya hujan merupakan bentuk kasih sayang
                                                        Allah
                                                        SWT pada hamba-Nya untuk mengirimkan air tawar yang dibutuhkan
                                                        hambanya di daratan.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-12"
                                                        value="b3-48" id="b3-48">
                                                    <label class="form-check-label" for="b3-48">
                                                        Saya meyakini bahwa adanya hujan salju merupakan kasih sayang
                                                        Allah
                                                        SWT pada hamba-Nya untuk mengirimkan air tawar yang dibutuhkan
                                                        makhluk-Nya di pegunungan yang tinggi.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-12"
                                                        value="b3-49" id="b3-49">
                                                    <label class="form-check-label" for="b3-49">
                                                        Saya meyakini bahwa adanya awan merupakan bukti keagungan Allah
                                                        SWT
                                                        sebagai yang Maha menciptakan dengan penuh perhitungan agar
                                                        dapat
                                                        menjadi media untuk menyebarkan air tawar ke penjuru daratan.
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="b3-12"
                                                        value="b3-50" id="b3-50">
                                                    <label class="form-check-label" for="b3-50">
                                                        Saya meyakini bahwa adanya angin merupakan bukti keagungan Allah
                                                        SWT
                                                        sebagai yang Maha menciptakan dengan penuh perhitungan agar
                                                        dapat
                                                        menjadi media untuk menggerakan awan ke tempat yang
                                                        dikehendaki-Nya.
                                                    </label>
                                                </div>
                                                <div class="container modal-footer">
...
<div id="standard-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <h6 id="bagian-1" class="text-center fw-bold text-primary custom-hover">DAFTAR ISI</h6>
                <a href="#daftar-1">
                ...
                <a href="#daftar-3-20" class="text-dark">
                    <p id="bagian-3-2 fw-bold"><span class="fst-italic">Collection/</span>Pengumpulan</p>
                </a>
                <a href="#daftar-3-21" class="text-dark">
                    <p id="bagian-3-2"><span class="fw-bold">Apply Knowledge:</span> Pengaruh penggundulan hutan pada
                    trasnpirasi</p>
                </a>
                <a href="#daftar-3-22" class="text-dark">
                    <p id="bagian-3-2"><span class="fw-bold">Awe Expereince:</span> Pengaruh penggundulan hutan pada
                    trasnpirasi</p>
                </a>
                <a href="#daftar-3-23" class="text-dark">
                    <p id="bagian-3-2"><span class="fw-bold">Spiritual Kognition:</span> Hikmah dibalik Anomali Suhu
                    Troposfer</p>
                </a>
                <a href="#daftar-3-24" class="text-dark">
                    <h6 id="bagian-3-3" class="fw-bold text-primary">Jenis-Jenis Siklus Air</h6>
                </a>
                <a href="#daftar-3-25" class="text-dark">
                    <p id="bagian-3-3 fw-bold">Siklus Pendek</p>
                </a>
                <a href="#daftar-3-26" class="text-dark">
                    <p id="bagian-3-3 fw-bold">Siklus Sedang</p>
                </a>
                <a href="#daftar-3-27" class="text-dark">
                    <p id="bagian-3-3 fw-bold">Siklus Panjang</p>
                </a>
                <a href="#daftar-3-28" class="text-dark">
                    <p id="bagian-3-3"><span class="fw-bold">Apply Knowledge:</span> Hujan Es dan Hujan Beku</p>
                </a>
                <a href="#daftar-3-29" class="text-dark">
                    <p id="bagian-3-3"><span class="fw-bold">Awe Expereince:</span> Peran Angin dalam Siklus Air</p>
                </a>
                <a href="#daftar-3-30" class="text-dark">
                    <p id="bagian-3-3"><span class="fw-bold">Spiritual Kognition:</span> Hikmah dibalik Adanya Siklus Air
                    </p>
                </a>
                <a href="#daftar-3-31" class="text-dark">
                    <p id="bagian-3-4" class="fw-bold text-primary">Refleksi Kognitif</p>
                </a>
                <a href="#daftar-3-31" class="text-dark">
                    <p id="bagian-3-5" class="fw-bold text-primary">Refleksi Spiritual</p>
                </a>
            </div>
        </div>
    </div>
